...
uses
  ...
  FMX.TMSFNCGrid, FMX.Controls.Presentation, FMX.TMSFNCGridExcelExport;
...
procedure TFSimpleImport.btnFecharClick(Sender: TObject);
begin
Close;
end;
...
procedure TFSimpleImport.btnExportarPDFClick(Sender: TObject);
begin
